...
import { Building2, Users, Wrench, DollarSign, AlertCircle, CheckCircle, Clock, Plus } from "lucide-react"
...
export default function AdminDashboard() {
  ...
  const isNewOrganization = orgBuildings.length === 0
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 p-8">
      <div className="container mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">{organization?.name || "Admin"} Dashboard</h1>
            <p className="text-muted-foreground">
              {isNewOrganization
                ? "Welcome! Start by adding your first building"
        ...
        {isNewOrganization ? (
          <Card className="p-12 text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">Welcome to {organization?.name}!</h2>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Your organization has been created successfully. Start by adding your first building to begin managing
              properties.
            </p>
            <div className="flex gap-3 justify-center">
              <Button size="lg" onClick={() => router.push("/admin/buildings")}>
                <Plus className="mr-2 h-5 w-5" />
                Add Your First Building
              </Button>
              <Button size="lg" variant="outline" onClick={() => router.push("/admin/settings/branding")}>
                Customize Branding
              </Button>
            </div>
          </Card>
